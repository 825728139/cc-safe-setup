...
**今日利用可能の利用者の側の防衛:**
- **無料の90秒の診断** (対話の道具): [Did Claude Code charge you wrong?](https://htmlpreview.github.io/?https://gist.githubusercontent.com/yurukusa/d3a0e2403cc4078aa0183400c137d824/raw/wrong-charge-diagnostic.html) — 5件の質問で利用者の事例を filed reports に照合、 support.anthropic.com に貼り付けるための返金の論理の素案を生成。 signup 不要、 telemetry なし、 単一の HTML。
